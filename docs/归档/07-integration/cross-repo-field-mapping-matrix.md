...
| 项目文档地址 | 无稳定主线    | `project.documentUrl` 或文档字段   | `projects.project.document_url`   | 保存项目文档、资料目录或 NAS 地址 |
| 项目仓库地址 | 无稳定主线    | `project.repositoryUrl` 或仓库字段 | `projects.project.repository_url` | 保存 GitLab/GitHub 等代码仓库地址 |
...
| 领域       | SmartWrite-AI | tech-material             | 主仓库统一落点          | 说明                                |
| ---------- | ------------- | ------------------------- | ----------------------- | ----------------------------------- |
| 物资主数据 | 无            | `material`                | `inventory` 主表        | 完整迁移语义                        |
